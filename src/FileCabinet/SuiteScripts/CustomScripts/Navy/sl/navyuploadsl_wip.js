    ...
    function onRequest(context) {
        ...
        if (context.request.method === 'GET') {
            ...
            arrItems.forEach(function (item, idx, arrItems) {
            	...
            	var sProductName = (item.description).toLowerCase();
            	var sParent = 'RS10099';
            	
            	
            	log.audit({title: 'Navy' , details: 'productName: ' + sProductName});
                ...
                if (parseInt(item.unitPrice) > 0 && !isNaN(item.unitPrice)) {
                    ...
                    log.audit({title: 'Navy' , details: 'adding new item:' + sItem});
                    ...
                    //	context.response.write( 'error on ' + sProductName + ' : ' + err );
                    //	return;
					//}
                    ...
                    log.audit({title: 'Navy' , details: 'commit new'});
